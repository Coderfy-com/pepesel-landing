...
export function AdaptiveUISection() {
  ...
  // Variants for falling animation
    ...
    <section className="relative w-full h-full bg-[#111113] overflow-hidden flex items-center justify-center">
      ...
      >
        ...
        >
          ...
          <div className="flex flex-col gap-[24px]">
            ...
            <div className="flex items-center gap-5">
              ...
              <span className="text-white font-normal leading-none text-[56px] -translate-y-0.5">2.0</span>
            </div>
          </div>
        ...
        <div 
          ...
          style={{ left: "1251px", top: "61px", width: "403px", height: "958px" }}
        >
        ...
        <div className="absolute inset-0 pointer-events-none z-20">
          <Badge text={t("badges.geo")} bg="#981A1E" x={861} y={139} rotate={-15} variants={badgeVariants(0.3)} />
          <Badge text={t("badges.activity")} bg="#EF4C35" x={606} y={372} rotate={-10} variants={badgeVariants(0.4)} />
          <Badge text={t("badges.voice")} bg="#FFFFFF" textColor="#0A0A0A" x={145} y={698} rotate={-27} width={330} variants={badgeVariants(0.8)} />
          <Badge text={t("badges.catalog")} bg="#23232A" x={606} y={720} rotate={32} width={650} variants={badgeVariants(0.5)} />

          {/* Stacked badges: Lang strictly above Theme */}
          <div className="absolute flex flex-col items-end pointer-events-none" style={{ left: "92px", top: "748px" }}>
            <motion.div
              variants={badgeVariants(0.6)}
              className="flex items-center justify-center px-[44px] h-[116px] rounded-full bg-[#EF4C35] shadow-2xl"
              style={{ width: "400px" }}
            >
              <span className="text-white font-montserrat font-bold text-[32px] leading-none whitespace-nowrap">{t("badges.lang")}</span>
            </motion.div>
            <motion.div
              variants={badgeVariants(0.7)}
              className="flex items-center justify-center px-[44px] h-[116px] rounded-full bg-[#981A1E] shadow-2xl"
              style={{ width: "720px" }}
            >
              <span className="text-white font-montserrat font-bold text-[32px] leading-none whitespace-nowrap">{t("badges.theme")}</span>
            </motion.div>
          </div>
        </div>
      </motion.div>
...
function Badge({ text, bg, textColor = "white", x, y, rotate, variants, width }: any) {
  return (
    <motion.div
      variants={variants}
    ...
    >
      <span className="font-montserrat font-bold text-[32px] leading-none whitespace-nowrap" style={{ color: textColor }}>
        {text}
      </span>
    </motion.div>
  );
